...
var Audio, ClickEvent, Gallery, Mixin, SelectGallery, SlideGallery,
...
ClickEvent = (function(_super) {

  __extends(ClickEvent, _super);

  function ClickEvent() {
    return ClickEvent.__super__.constructor.apply(this, arguments);
  }

  ClickEvent.prototype.click_event = function(start, pause, stop) {
    var _this = this;
...
SlideGallery = (function(_super) {
  ...
  function SlideGallery(main_dom, list_dom, audio, volume) {
    ...
    ClickEvent.prototype.augment(this);
    this.timerId = 0;
